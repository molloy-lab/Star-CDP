"""
This python script scores a tree under the star homoplasy model 
and then contracts edges on which there were no mutations.

Written by EKM in July 2023; updated in October 2023.
"""
import argparse
import pandas
import numpy
